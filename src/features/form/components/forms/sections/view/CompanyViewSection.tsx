      ...
      <CardContent className="space-y-6">
          ...
          companyData.data_integralizacao && (
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                ...
                {new Date(companyData.data_integralizacao).toLocaleDateString(
                  'pt-BR',
                )}
              </p>
            </div>
        ...
        <div className="border-t pt-6">
          ...
          <div className="space-y-1 text-sm text-gray-700">
            <p>
              {companyData.endereco.rua}, {companyData.endereco.numero}
            </p>
            {companyData.endereco.complemento && (
              <p>{companyData.endereco.complemento}</p>
            )}
            <p>
              {companyData.endereco.bairro} - {companyData.endereco.municipio}/
              {companyData.endereco.uf}
            </p>
            <p>CEP: {companyData.endereco.cep}</p>
          </div>
        </div>

        {companyData.opcoes_nome_empresa &&
          companyData.opcoes_nome_empresa.length > 0 && (
            <div className="border-t pt-6">
              <h4 className="font-medium text-gray-900 mb-3">
                Opções de Nome da Empresa
              </h4>
          ...
          <div className="border-t pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <InfoField
                ...
                value={
                  companyData.info_adicionais.nmr_carteira_profissional || 'N/A'
                }
              />
              <InfoField
