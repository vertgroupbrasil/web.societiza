    ...
    const handleConfirmTitle = useCallback(() => {
      ...
      if (trimmed && trimmed !== step.title) {
        updateStep.mutate({
          templateId,
          stepId: step.id,
          data: { title: trimmed, description: step.description, order: step.order },
        });
      }
      ...
      (field: WorkflowTemplateField) => {
        ...
        if (trimmed && trimmed !== field.label) {
          updateStepField.mutate({
            ...
            stepId: step.id,
            fieldId: field.id,
            data: { label: trimmed, fieldType: field.fieldType, options: field.options },
          });
        }
            ...
            <div className="flex items-center justify-between min-w-0">
              ...
              <div className="flex items-center gap-1 flex-shrink-0 ml-2">
                ...
                <Button
                  ...
                  onClick={() => removeStep.mutate({ templateId, stepId: step.id })}
