  ...
  return (
    <div id="problema" className="py-16 md:py-20">
      <div className="mb-12 text-center">
        <div className="mx-auto mb-6 w-fit rounded-md border px-4 py-1 text-sm">Comparativo</div>
        ...
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          Veja como a sua rotina muda quando você deixa de improvisar e passa a usar um sistema feito para contabilidades.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-3xl overflow-hidden rounded-xl border bg-card">
        ...
        <div className="grid grid-cols-[1fr_120px_120px] border-b bg-muted/50 md:grid-cols-[1fr_160px_160px]">
          <div className="p-4 md:p-5">
            <span className="font-medium text-sm text-muted-foreground">Benefício</span>
          </div>
          <div className="flex items-center justify-center border-l p-4 md:p-5">
            <span className="text-center font-medium text-xs text-muted-foreground md:text-sm">Contador Comum</span>
          </div>
          <div className="flex items-center justify-center border-l bg-primary/5 p-4 md:p-5">
            <span className="text-center font-semibold text-xs text-primary md:text-sm">Contador Societizado</span>
          </div>
        </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-muted-foreground text-sm">
          Pare de improvisar. <span className="font-medium text-foreground">Seja um contador societizado.</span>
        </p>
      </div>
    </div>
  );
