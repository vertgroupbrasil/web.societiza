      ...
      <div className="py-20 text-right md:py-28 justify-center flex">
        ...
        <div className="justify-center flex flex-col">
          ...
          <p className="ml-auto mt-6 max-w-2xl text-muted-foreground text-sm leading-relaxed md:text-base">
            A burocracia brasileira não vai desaparecer. Mas a forma de lidar
            com ela pode evoluir. A Societiza nasceu com um objetivo claro:
            transformar o processo societário em algo organizado, transparente e
