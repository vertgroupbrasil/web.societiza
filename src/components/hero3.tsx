			...
			<div className="relative flex flex-col items-center justify-center gap-5 px-4 py-12 md:px-4 md:py-24 lg:py-28">
				...
				>
					...
					<motion.div className="group relative mx-auto flex items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#ff550020] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#ff550035]">
						...
						/>
						<AnimatedGradientText colorFrom="#FF5500" colorTo="#FF8C40" speed={0.6} className="text-sm font-medium">
						...
						>
					Organize, automatize e acompanhe todo o processo de abertura de empresas em um workflow societário totalmente customizável.
				</motion.p>
