...
const pricingPlans: PricingPlan[] = [
  {
    ...
    description:
      'Organize e profissionalize sua gestão societária sem nenhum custo.',
  ...
  },
  {
    ...
    description:
      'Tudo do plano Salinha, preparado para equipes e maior escala de operação.',
        ...
        <div className="grid grid-cols-1 gap-px bg-border md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col bg-background p-8 md:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground text-sm md:text-base">
              Da organização do contador independente à escala de escritórios
              contábeis.
            </p>
